...
<div class="error">
  ...
  <div class="error__description" style="color:black !important;">Izgleda da traženi sadržaj ne postoji</div>
  <a class="error__button error__button--active" href="{{route('show_main_page')}}" style="margin-top: 2rem !important;">POVRATAK</a>
